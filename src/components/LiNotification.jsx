  ...
  return (
    <li>
      ...
      <div className="info">
        ...
        <p className='fs-09'>Информацию о заказе вы можете посмотреть во вкладке «Заказы»</p>
      </div>
      <div className="links">
        {
          (isMobileMD)
          ? <button type='button' className='btn-11 d-flex align-items-center px-2 py-1'>
            <span>Перейти</span>
            <HiChevronRight/>
          </button>
